...
public class TeacherController {
  ...
  @ApiOperation("列表")
  @GetMapping("/v1/teacher/list")
  public ResponseResult<Iterable<Teacher>> getAll() {
    return ResponseResultGenerator.success("获取成功", service.getList());
  }

  @ApiOperation("添加")
  @PostMapping("/v1/teacher/add")
  public ResponseResult<Void> add(@RequestBody @Valid TeacherAddParams params) {
    service.add(params);
    return ResponseResultGenerator.success("添加成功", null);
  }

  @ApiOperation("编辑")
  @PostMapping("/v1/teacher/edit/{id}")
  public ResponseResult<Void> edit(@ApiParam("ID") @PathVariable("id") Integer id, @RequestBody @Valid TeacherAddParams params) throws ApiException {
    service.edit(id, params);
    return ResponseResultGenerator.success("编辑成功", null);
  }

  @ApiOperation("删除")
  @PostMapping("/v1/teacher/delete/{id}")
